...
var entertainmentData = [
  {
    ...
    text: entertainment250.map(x => "Channel: " + x['Username'] + "<br>" +
    "Subs: " + (x['Subscribers'] / 1000000) + "M"),
    mode: "markers",
    marker: {
      size: entertainment250.map(x => x['Subscribers'] / 1000000 ),
      color: entertainment250.map(x => x['Subscribers']),
      colorscale: "Earth"
    }
  }
];

var entertainmentLayout = {
  margin: { t: 50 },
  hovermode: "closest",
  title: "Total Views vs Uploads",
  xaxis: { title: "Uploads" },
...
Plotly.plot("entertainmentPlot1", entertainmentData, entertainmentLayout);
